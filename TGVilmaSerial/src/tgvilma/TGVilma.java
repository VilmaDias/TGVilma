 ...
 * @author Vilma
 */
public class TGVilma {
  private OutputStream serialOut;
  private int taxa;
  private String portaCOM; 
  /**
   * Construtor da classe TGVilma
   * @param portaCOM3 - Porta COM que será utilizada para enviar os dados para o arduino
   * @param taxa - Taxa de transferência da porta serial geralmente é 9600
   */
  public TGVilma(String portaCOM, int taxa) {
